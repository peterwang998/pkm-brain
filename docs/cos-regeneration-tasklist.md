...
- **Current fact-quality blocker added 2026-07-06:** H1c prompt hardening plus resolver no-op suppression removed the bogus `fact_supersede` audit failures. The low-effort rerun still had 7/33 audited fact-upserts marked bad; the medium-effort rerun improved to 4/34 but still exceeded the policy demotion threshold. Live extractor effort is now `medium` and live policy v4 critic-gates clean new fact-upserts; rerun this posture before any T4.1 apply.
